...
public final class AddServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.tryingpfq.grpc.AddRequest,
      com.tryingpfq.grpc.AddReply> getAddMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "add",
      requestType = com.tryingpfq.grpc.AddRequest.class,
      responseType = com.tryingpfq.grpc.AddReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tryingpfq.grpc.AddRequest,
      com.tryingpfq.grpc.AddReply> getAddMethod() {
    io.grpc.MethodDescriptor<com.tryingpfq.grpc.AddRequest, com.tryingpfq.grpc.AddReply> getAddMethod;
      ...
      synchronized (AddServiceGrpc.class) {
        if ((getAddMethod = AddServiceGrpc.getAddMethod) == null) {
          AddServiceGrpc.getAddMethod = getAddMethod =
              io.grpc.MethodDescriptor.<com.tryingpfq.grpc.AddRequest, com.tryingpfq.grpc.AddReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "add"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tryingpfq.grpc.AddRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tryingpfq.grpc.AddReply.getDefaultInstance()))
  ...
  public static abstract class AddServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void add(com.tryingpfq.grpc.AddRequest request,
        io.grpc.stub.StreamObserver<com.tryingpfq.grpc.AddReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.tryingpfq.grpc.AddRequest,
                com.tryingpfq.grpc.AddReply>(
                  this, METHODID_ADD)))
          .build();
    }
  }
  ...
  public static final class AddServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AddServiceBlockingStub> {
    ...
    /**
     */
    public com.tryingpfq.grpc.AddReply add(com.tryingpfq.grpc.AddRequest request) {
  ...
  public static final class AddServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AddServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tryingpfq.grpc.AddReply> add(
        com.tryingpfq.grpc.AddRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD:
          serviceImpl.add((com.tryingpfq.grpc.AddRequest) request,
              (io.grpc.stub.StreamObserver<com.tryingpfq.grpc.AddReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class AddServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tryingpfq.grpc.AddServiceProto.getDescriptor();
    }
